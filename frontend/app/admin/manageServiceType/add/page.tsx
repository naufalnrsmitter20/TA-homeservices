...
export default function AddUser() {
  ...
  const HandleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!res.ok) {
        toast.error(data.message || "ServicesT ype Added failed", { id: toastId });
        throw new Error(data.message || "Failed to update Services Type");
      }
      toast.success(data.message || "Services Type Added successfully", { id: toastId });
  ...
  return (
    <div className="mt-6">
      <h2 className="text-2xl font-semibold text-gray-800 mb-6">Add Services Type</h2>
